...
export type ConfirmSignUpMutation = { __typename?: "Mutation" } & {
  confirmSignUp: { __typename?: "UserResponse" } & {
    errors?: Maybe<
      Array<
        { __typename?: "FieldError" } & Pick<FieldError, "field" | "message">
      >
...
export type CreateLayoutMutation = { __typename?: "Mutation" } & {
  createCustomLayout?: Maybe<
    { __typename?: "CustomLayoutResponse" } & {
      ...
      >;
      customLayout?: Maybe<
        { __typename?: "CustomLayout" } & Pick<CustomLayout, "id" | "name"> & {
            positions: Array<
              { __typename?: "Position" } & Pick<Position, "x" | "y">
            >;
          }
      >;
    }
...
export type CreatePlayerMutation = { __typename?: "Mutation" } & {
  createPlayer: { __typename?: "Player" } & Pick<
    Player,
...
export type CreateShareLinkMutation = { __typename?: "Mutation" } & {
  createShareLink: { __typename?: "ShareLink" } & Pick<
    ShareLink,
    "id" | "name" | "createdAt"
  > & {
      positions: Array<
        { __typename?: "ShareLinkPosition" } & Pick<
          ShareLinkPosition,
          "id" | "x" | "y"
        > & {
            player?: Maybe<
              { __typename?: "ShareLinkPlayer" } & Pick<
                ShareLinkPlayer,
                "id" | "firstName" | "lastName" | "number" | "nickName" | "age"
              >
            >;
          }
      >;
...
export type DeleteCustomLayoutMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "deleteCustomLayout"
>;
...
export type DeletePlayerMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "deletePlayer"
>;
...
export type EditCustomLayoutMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "editCustomLayout"
>;
...
export type EditPlayerMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "editPlayer"
>;
...
export type ForgotPaswordMutation = { __typename?: "Mutation" } & Pick<
  Mutation,
  "forgotPassword"
>;
...
export type ShareLinkQuery = { __typename?: "Query" } & {
  shareLink?: Maybe<
    { __typename?: "ShareLink" } & Pick<
      ShareLink,
      "id" | "name" | "createdAt" | "snapshotUrl"
    > & {
        positions: Array<
          { __typename?: "ShareLinkPosition" } & Pick<
            ShareLinkPosition,
...
export type ListLayoutsQuery = { __typename?: "Query" } & {
  layouts?: Maybe<
    Array<
      { __typename?: "Layout" } & Pick<Layout, "id" | "name" | "createdAt"> & {
          positions: Array<
            { __typename?: "Position" } & Pick<Position, "x" | "y">
          >;
        }
...
export function getSdk(
  ...
  return {
    ...
    ConfirmSignUp(
      variables: ConfirmSignUpMutationVariables,
      requestHeaders?: Headers
    ): Promise<ConfirmSignUpMutation> {
      return withWrapper(() =>
        client.request<ConfirmSignUpMutation>(
          print(ConfirmSignUpDocument),
          variables,
          requestHeaders
        )
      );
    ...
    CreateLayout(
      variables: CreateLayoutMutationVariables,
      requestHeaders?: Headers
    ): Promise<CreateLayoutMutation> {
      return withWrapper(() =>
        client.request<CreateLayoutMutation>(
          print(CreateLayoutDocument),
          variables,
          requestHeaders
        )
      );
    ...
    CreateShareLink(
      variables: CreateShareLinkMutationVariables,
      requestHeaders?: Headers
    ): Promise<CreateShareLinkMutation> {
      return withWrapper(() =>
        client.request<CreateShareLinkMutation>(
          print(CreateShareLinkDocument),
          variables,
          requestHeaders
        )
      );
    ...
    DeleteCustomLayout(
      variables: DeleteCustomLayoutMutationVariables,
      requestHeaders?: Headers
    ): Promise<DeleteCustomLayoutMutation> {
      return withWrapper(() =>
        client.request<DeleteCustomLayoutMutation>(
          print(DeleteCustomLayoutDocument),
          variables,
          requestHeaders
        )
      );
    ...
    EditCustomLayout(
      variables: EditCustomLayoutMutationVariables,
      requestHeaders?: Headers
    ): Promise<EditCustomLayoutMutation> {
      return withWrapper(() =>
        client.request<EditCustomLayoutMutation>(
          print(EditCustomLayoutDocument),
          variables,
          requestHeaders
        )
      );
    ...
    EditPlayer(
      variables: EditPlayerMutationVariables,
      requestHeaders?: Headers
    ): Promise<EditPlayerMutation> {
      return withWrapper(() =>
        client.request<EditPlayerMutation>(
          print(EditPlayerDocument),
          variables,
          requestHeaders
        )
      );
    ...
    ForgotPasword(
      variables: ForgotPaswordMutationVariables,
      requestHeaders?: Headers
    ): Promise<ForgotPaswordMutation> {
      return withWrapper(() =>
        client.request<ForgotPaswordMutation>(
          print(ForgotPaswordDocument),
          variables,
          requestHeaders
        )
      );
    ...
    ResendConfirmationCode(
      variables: ResendConfirmationCodeMutationVariables,
      requestHeaders?: Headers
    ): Promise<ResendConfirmationCodeMutation> {
      return withWrapper(() =>
        client.request<ResendConfirmationCodeMutation>(
          print(ResendConfirmationCodeDocument),
          variables,
          requestHeaders
        )
      );
    ...
    ShareLink(
      variables: ShareLinkQueryVariables,
      requestHeaders?: Headers
    ): Promise<ShareLinkQuery> {
      return withWrapper(() =>
        client.request<ShareLinkQuery>(
          print(ShareLinkDocument),
          variables,
          requestHeaders
        )
      );
    ...
    ListLayouts(
      variables?: ListLayoutsQueryVariables,
      requestHeaders?: Headers
    ): Promise<ListLayoutsQuery> {
      return withWrapper(() =>
        client.request<ListLayoutsQuery>(
          print(ListLayoutsDocument),
          variables,
          requestHeaders
        )
      );
    ...
    Players(
      ...
      requestHeaders?: Headers
    ): Promise<PlayersQuery> {
      return withWrapper(() =>
        client.request<PlayersQuery>(
          print(PlayersDocument),
          variables,
          requestHeaders
        )
      );
